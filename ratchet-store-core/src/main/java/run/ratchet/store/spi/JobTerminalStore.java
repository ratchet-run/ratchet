 ...
 *
 * <p>Separated from {@link JobStatusStore} during the status-SPI decomposition. Implementations
 * are expected to flip a live job to its terminal form atomically (for the hot/cold MySQL store,
 * this means hot DELETE + cold UPDATE + bkres DELETE in a single transaction).
 */
@Incubating
