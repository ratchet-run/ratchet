...
/**
 * JSON-P encoder/decoder for the Hazelcast coordinator's wire envelope. Identical wire shape to the
 * PG / JMS / Infinispan coordinators so operators see the same JSON across transports.
 */
final class HazelcastNotifyPayloadCodec {
  ...
  /**
   * Decoded envelope passed between the topic listener and dispatch path. {@code cid} is an
