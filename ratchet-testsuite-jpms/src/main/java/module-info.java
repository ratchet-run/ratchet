 ...
 * success of this module IS the verification. The module also requires {@code
 * run.ratchet.ri} to prove the RI resolves as a named module without exporting its
