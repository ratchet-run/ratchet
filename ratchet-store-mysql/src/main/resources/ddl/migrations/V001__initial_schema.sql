-- Ratchet MySQL V001 — initial schema.
-- Baseline schema. V002 adds the hot/cold store split.
-- Applies cleanly to an empty database.

-- 0. Schema version ledger. Used by external migration tooling or the opt-in SchemaMigrator.
...
INSERT IGNORE INTO ratchet_schema_version (version, description)
