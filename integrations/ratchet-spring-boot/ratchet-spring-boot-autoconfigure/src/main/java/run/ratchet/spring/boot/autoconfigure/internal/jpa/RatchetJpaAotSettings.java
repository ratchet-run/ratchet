...
public final class RatchetJpaAotSettings {
  public static final String RESOURCE = "META-INF/ratchet/spring-jpa-aot.properties";
  public static final String ISOLATION_RESOURCE =
      "META-INF/ratchet/spring-jpa-isolation-aot.properties";
  ...
  private static Properties load() {
    ...
    for (String resource : new String[] {ISOLATION_RESOURCE, RESOURCE}) {
      try (var stream =
          RatchetJpaAotSettings.class.getClassLoader().getResourceAsStream(resource)) {
