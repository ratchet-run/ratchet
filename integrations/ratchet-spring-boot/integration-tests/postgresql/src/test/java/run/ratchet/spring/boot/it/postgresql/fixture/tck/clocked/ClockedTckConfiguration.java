 ...
 */
package run.ratchet.spring.boot.it.postgresql.fixture.tck.clocked;
...
import run.ratchet.spring.boot.it.postgresql.fixture.tck.TckConfiguration;
...
/** Beans replacing PostgreSQL time and storage for the clock-dependent contract. */
