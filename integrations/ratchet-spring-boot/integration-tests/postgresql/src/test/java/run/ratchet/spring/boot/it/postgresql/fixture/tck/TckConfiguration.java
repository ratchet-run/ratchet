...
/** Spring beans adapting the shared API TCK to the PostgreSQL-backed runtime. */
@Configuration(proxyBeanMethods = false)
public class TckConfiguration {

  public static final String APPLICATION_PACKAGE = "run.ratchet.spring.boot.it.postgresql";
