...
/** Supplies the shared PostgreSQL container before Spring creates the application context. */
public final class TckApplicationContextInitializer
  ...
  public void initialize(ConfigurableApplicationContext applicationContext) {
    TestPropertyValues.of(
            "spring.datasource.url=" + PostgresqlContainerExtension.jdbcUrl(),
            "spring.datasource.username=" + PostgresqlContainerExtension.username(),
            "spring.datasource.password=" + PostgresqlContainerExtension.password(),
