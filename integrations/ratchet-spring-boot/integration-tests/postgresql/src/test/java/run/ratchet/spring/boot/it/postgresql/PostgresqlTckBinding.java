...
/** PostgreSQL-specific container and property binding for the shared Spring TCK. */
public class PostgresqlTckBinding extends SqlStoreTckBinding {

  private final PostgresqlContainerExtension containerExtension =
  ...
  public String applicationPackage() {
    return "run.ratchet.spring.boot.it.postgresql";
  }
