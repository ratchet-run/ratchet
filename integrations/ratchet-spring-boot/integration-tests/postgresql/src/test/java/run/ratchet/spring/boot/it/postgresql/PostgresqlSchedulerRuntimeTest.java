...
/** End-to-end proof that the starter owns a complete PostgreSQL scheduler runtime. */
@ExtendWith(OutputCaptureExtension.class)
public class PostgresqlSchedulerRuntimeTest extends PostgresqlIntegrationTestSupport {
  ...
  static class RuntimeTestConfiguration {
    ...
    ApplicationRunner qualifyingRunner(
      ...
      return arguments -> {
        ...
        RuntimePayload payload = new RuntimePayload("spring-postgresql", 8);
