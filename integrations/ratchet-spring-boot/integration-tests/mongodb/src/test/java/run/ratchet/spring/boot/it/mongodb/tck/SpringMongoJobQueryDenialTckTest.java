...
/** Spring MongoDB binding for {@link AbstractJobQueryDenialContract}. */
@SpringMongoTck
@Import(SpringMongoJobQueryDenialTckTest.DenyReadConfiguration.class)
class SpringMongoJobQueryDenialTckTest extends AbstractJobQueryDenialContract {
  ...
  static class DenyReadConfiguration {
    ...
    JobAuthorizationPolicy denyReadJobAuthorizationPolicy() {
      return new MongoDenyReadJobAuthorizationPolicy();
    }
  }
}

final class MongoDenyReadJobAuthorizationPolicy implements JobAuthorizationPolicy {
