 ...
 */
package run.ratchet.spring.boot.it.mongodb.fixture.tck.clocked;
...
import run.ratchet.spring.boot.it.mongodb.fixture.tck.MongoTckConfiguration;
...
/** Beans replacing MongoDB time and storage for the clock-dependent contract. */
@Configuration(proxyBeanMethods = false)
public class MongoClockedTckConfiguration {

  @Bean
  RatchetOptions mongoClockedTckRatchetOptions() {
  ...
  @Bean
  @Primary
  InMemoryJobStore mongoClockedJobStore(Clock clock) {
  ...
  @Bean
  SpringMongoClockedTckRuntime springMongoClockedTckRuntime(
    ...
    return new SpringMongoClockedTckRuntime(
