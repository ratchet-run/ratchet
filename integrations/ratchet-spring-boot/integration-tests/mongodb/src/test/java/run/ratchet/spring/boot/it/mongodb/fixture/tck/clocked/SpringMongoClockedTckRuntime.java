...
/** Mongo-lane TCK runtime backed by the shared in-memory store and stepping clock. */
public final class SpringMongoClockedTckRuntime implements RatchetTckRuntime {
  ...
  public SpringMongoClockedTckRuntime(
