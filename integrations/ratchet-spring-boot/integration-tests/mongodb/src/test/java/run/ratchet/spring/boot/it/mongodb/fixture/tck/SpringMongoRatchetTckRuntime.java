...
/** Spring {@link RatchetTckRuntime} bridge for the MongoDB-backed API contracts. */
public final class SpringMongoRatchetTckRuntime implements RatchetTckRuntime {
  ...
  private final MongoTckStoreCleaner storeCleaner;
  private final RatchetOptions options;

  public SpringMongoRatchetTckRuntime(
  ...
  public void clear() {
    RatchetTckRuntimeSupport.clearRuntime(
        "SpringMongoRatchetTckRuntime",
        drainController::setDraining,
        executor::awaitIdle,
        storeCleaner::clearAll,
        probe::reset);
  }
}
