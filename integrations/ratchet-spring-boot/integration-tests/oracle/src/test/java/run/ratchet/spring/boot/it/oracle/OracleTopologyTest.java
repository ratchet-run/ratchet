...
class OracleTopologyTest extends OracleIntegrationTestSupport {

  @Test
  void createsOneJpaTopologyFromTheInstalledRatchetMappingAndProxiesTheStore() {
    contextRunner(RatchetOnlyApplication.class, migrationOptions(""))
        .run(
            context -> {
              ...
              Method create = OracleJobStore.class.getMethod("create", JobEntity.class);
