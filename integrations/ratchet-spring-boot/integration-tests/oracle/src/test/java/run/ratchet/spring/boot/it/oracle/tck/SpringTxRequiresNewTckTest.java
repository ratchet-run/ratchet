...
import run.ratchet.spring.boot.it.oracle.fixture.tck.SpringRatchetTransactionDriver;
import run.ratchet.tck.api.RatchetTckRuntime;
import run.ratchet.tck.api.TckJobs;
import run.ratchet.tck.api.transaction.AbstractTxRequiresNewContract;
import run.ratchet.tck.api.transaction.RatchetTransactionDriver;

/** Spring Oracle binding for {@link AbstractTxRequiresNewContract}. */
@SpringOracleTck
class SpringTxRequiresNewTckTest extends AbstractTxRequiresNewContract {
