...
import run.ratchet.tck.api.transaction.AbstractTxRequiredContract;
import run.ratchet.tck.api.transaction.RatchetTransactionDriver;

/** Spring Oracle binding for {@link AbstractTxRequiredContract}. */
@SpringOracleTck
class SpringTxRequiredTckTest extends AbstractTxRequiredContract {
