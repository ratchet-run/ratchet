...
import run.ratchet.tck.api.transaction.AbstractTxDlqOrderContract;
import run.ratchet.tck.api.transaction.RatchetTransactionDriver;

/** Spring Oracle binding for {@link AbstractTxDlqOrderContract}. */
@SpringOracleTck
class SpringTxDlqOrderTckTest extends AbstractTxDlqOrderContract {
