...
class OracleDependencyVersionTest {

  @Test
  void resolvesPinnedTestcontainersOracle205() throws Exception {
    Path artifact =
        Path.of(OracleContainer.class.getProtectionDomain().getCodeSource().getLocation().toURI());

    assertThat(artifact.getFileName().toString()).isEqualTo("testcontainers-oracle-free-2.0.5.jar");
