 ...
 */
package run.ratchet.spring.boot.it.mysql.fixture.tck.clocked;
...
import run.ratchet.spring.boot.it.mysql.fixture.tck.TckConfiguration;
...
/** Beans replacing MySQL time and storage for the clock-dependent contract. */
