 ...
 * MySQL {@code DATETIME(6)} column back through Hibernate 7's native-query path must recover the
 * exact instant that was written, not a value shifted by the JVM default zone offset.
 */
class MysqlInstantRoundTripTest extends MysqlIntegrationTestSupport {
  ...
  @Test
  void instantRoundTripsExactlyThroughMysqlDatetimeColumn() {
