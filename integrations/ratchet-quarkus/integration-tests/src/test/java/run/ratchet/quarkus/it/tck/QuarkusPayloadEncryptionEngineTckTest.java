...
/** Quarkus binding for {@link AbstractPayloadEncryptionEngineContract}. */
@QuarkusTest
@TestProfile(QuarkusRatchetTckProfile.class)
class QuarkusPayloadEncryptionEngineTckTest extends AbstractPayloadEncryptionEngineContract {
