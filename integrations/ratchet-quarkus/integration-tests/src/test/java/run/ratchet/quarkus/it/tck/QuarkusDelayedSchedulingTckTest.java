...
/** Quarkus binding for {@link AbstractDelayedSchedulingContract}. */
@QuarkusTest
@TestProfile(QuarkusClockedProfile.class)
class QuarkusDelayedSchedulingTckTest extends AbstractDelayedSchedulingContract {

  @Inject QuarkusClockedTckRuntime runtime;
