...
class SecurityContextPrincipalSourceTest {

  private static final class UnmanagedSecurityContextPrincipalSource
      extends SecurityContextPrincipalSource {}
  ...
  void currentPrincipal_unmanagedNoArgConstruction_throws() {
    IllegalStateException exception =
        assertThrows(
            ...
            () -> new UnmanagedSecurityContextPrincipalSource().currentPrincipal());
