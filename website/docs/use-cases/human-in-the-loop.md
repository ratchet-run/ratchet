...
::: tip Verified
The Java on this page compiles against `ratchet-api` `0.2.1`. It shows real API usage, not pseudocode. The running app needs a Jakarta EE server and a store that advertises the `SignalStore` capability.
:::
