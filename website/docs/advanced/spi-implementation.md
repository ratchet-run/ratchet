...
Receives 23 callbacks covering job outcomes, success finalization, claims and submission gates, wakeups and executor routing, callback and signal events, store timing, poller and application circuit breakers, and encryption integrity/version signals. The complete callback and meter catalog is in [Metrics Collection](./metrics-collection.md#metricscollector-spi).
