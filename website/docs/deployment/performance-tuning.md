...
The bundled adapter covers all 23 `MetricsCollector` callbacks, including store-finalization fallbacks, claim-breaker state, and encryption rollout signals. See [Monitoring](./monitoring.md#published-metrics) for the meter catalog and setup.
