...
class MysqlJobStoreImpl implements MysqlJobStore {
  ...
  public JobCompletionResult commitCompletion(JobCompletionPlan plan) {
    return SqlJobCompletion.commit(em, this, this, plan, false, UuidByteArrayConverter::toBytes);
  }
  ...
  private void initDelegates() {
    ...
    recurringJobs = new MysqlRecurringJobOperations(ctx, reservations, this::bulkInsert);
