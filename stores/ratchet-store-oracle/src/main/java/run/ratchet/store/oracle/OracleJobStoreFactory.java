...
/** Creates ready-to-use Oracle job stores without requiring CDI. */
public final class OracleJobStoreFactory {

  private OracleJobStoreFactory() {}

  /**
   * Creates and fully initializes an Oracle job store.
   *
   ...
   * @return an initialized Oracle job store
   */
  public static OracleJobStore create(
    ...
    OracleJobStoreImpl store =
        new OracleJobStoreImpl(entityManagerProvider, metricsCollector, options);
    store.initialize();
    return store;
  }
}
