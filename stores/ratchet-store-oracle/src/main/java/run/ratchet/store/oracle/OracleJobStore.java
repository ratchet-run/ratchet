...
/**
 * Public Oracle-specific store type.
 *
 ...
 *
 * <p>The Oracle store advertises every optional capability, so this type extends the mandatory
 ...
 */
public interface OracleJobStore
    extends JobStore,
        RecurringJobStore,
        BatchStore,
