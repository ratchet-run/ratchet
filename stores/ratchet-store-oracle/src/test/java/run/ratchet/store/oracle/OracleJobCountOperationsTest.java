...
class OracleJobCountOperationsTest {
  ...
  void doubleStatsReturnZeroWhenNativeAggregateReturnsNull() {
    OracleJobCountOperations counts =
        new OracleJobCountOperations(new OracleStoreContext(entityManagerReturningNull(), null));
  ...
  void countActiveNodesUsesNativeSchedulerNodeCount() {
    ...
    OracleJobCountOperations counts =
        new OracleJobCountOperations(
            new OracleStoreContext(entityManagerReturningCount(sql, 3L), null));
  ...
  void queueWaitPercentileUsesWindowPercentileQuery() {
    ...
    OracleJobCountOperations counts =
        new OracleJobCountOperations(
            new OracleStoreContext(entityManagerForPercentile(percentile), null));
