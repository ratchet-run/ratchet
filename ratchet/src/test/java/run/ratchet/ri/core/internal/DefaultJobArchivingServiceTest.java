...
class DefaultJobArchivingServiceTest {
  ...
  private DefaultJobArchivingService service;
  ...
  void schedulerConfigurationReadByWorkerThreads_isVolatile() throws Exception {
    Assertions.assertTrue(
        Modifier.isVolatile(
            DefaultJobArchivingService.class.getDeclaredField("enabled").getModifiers()));
    Assertions.assertTrue(
        Modifier.isVolatile(
            DefaultJobArchivingService.class.getDeclaredField("cron").getModifiers()));
    Assertions.assertTrue(
        Modifier.isVolatile(
            DefaultJobArchivingService.class.getDeclaredField("zone").getModifiers()));
    Assertions.assertTrue(
        Modifier.isVolatile(
            DefaultJobArchivingService.class.getDeclaredField("retentionPeriod").getModifiers()));
    Assertions.assertTrue(
        Modifier.isVolatile(
            DefaultJobArchivingService.class.getDeclaredField("batchSize").getModifiers()));
  }
  ...
  void stopDoesNotAdvertiseTransactionalRollbackSemantics() throws Exception {
    Transactional tx =
        DefaultJobArchivingService.class.getMethod("stop").getAnnotation(Transactional.class);
