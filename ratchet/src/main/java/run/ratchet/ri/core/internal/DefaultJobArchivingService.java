...
@ApplicationScoped
@Transactional
public class DefaultJobArchivingService implements JobArchivingService {

  private static final Logger log = Logger.getLogger(DefaultJobArchivingService.class);
